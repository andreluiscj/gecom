      ...
      <Card className="mb-6">
        <CardHeader>
          <div className="flex items-center gap-4">
            <img src="/lovable-uploads/16b8bdb2-a18d-4ef2-8b14-ce836cb5bef0.png" alt="GECOM Logo" className="h-12 object-cover" />
            <div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="bg-primary/5 hover:bg-primary/10 transition-colors cursor-pointer" onClick={() => navigate('/admin/gerentes')}>
              <CardContent className="p-6">
                <div className="flex items-center gap-3">
