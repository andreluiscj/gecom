...
// Serviços de autenticação Supabase corrigidos e limpos

import { supabase } from "@/integrations/supabase/client";

// Login padrão usando email como usuário
...
// Busca municípios do usuário (ajustado para table correta)
export const getUserMunicipalities = async (userId) => {
 try {
   const { data, error } = await supabase
